...
\usepackage[bottom]{footmisc} % for bottom footnotes
\usepackage{fullwidth}
\usepackage{gensymb}
\usepackage[left=2.5 cm, right=2.5 cm, top=2 cm, bottom=2 cm]{geometry} % was 2 for right, 3 left
...
\usepackage{floatflt} % testing for fix wrapfigure
\usepackage{xcolor}
...
%    top=2cm,
%    bottom=2cm,
%    inner=3cm, % left margin for odd pages, right margin for even pages
%    outer=2cm, % right margin for odd pages, left margin for even pages
%    %headheight=14pt,
%    %headsep=1.2cm,
%    %footskip=1.2cm
%}
...
% For subfire reference with subcaption
...
% For crazy background 2
\newcommand\AddBackgroundPic{
  \put(-0.5cm,-0.01cm){
    \parbox[b][\paperheight]{\paperwidth}{%
      \vfill
      \centering
      \includegraphics[width=1.02\paperwidth,height=1.01\paperheight]{Images/firstpage.pdf}
      \vfill
    }
  }
}
...
\fancyhead[L]{\small \color{oxfordblue} \textit{Chapter \thechapter: \leftmark}}
\fancyhead[R]{\small \color{oxfordblue} \textit{University of Oxford}}
\lfoot{}
\cfoot{\thepage}
      ...
      \backgroundsetup{contents={%
        \begin{tikzpicture}[overlay,remember picture]
          \node[
            ...
            rectangle,
            text width=0.8cm,
            text height=2.7cm, %3cm
            align=center,
            anchor=north east
          ] 
          at ($ (current page.north east) + (-0cm,-2.7*\thechapshift cm) $) 
          {\rotatebox{90}{\hspace*{1.35cm}\parbox[c][1.75cm][c]{2.7cm}{% %3cm
    ...
    \else
      \backgroundsetup{contents={%
        ...
        \node[
          ...
          text height=2.7cm, %3cm
          align=center,
          anchor=north west %east
        ] 
        at ($ (current page.north west) + (-0cm,-2.7*\thechapshift cm) $)  %east
        {\rotatebox{90}{\hspace*{1.35cm}\parbox[c][1.75cm][c]{2.7cm}{% %3cm
            \raggedright\textcolor{white}{\scshape \vspace{0.9cm}\thechapter}}}};
        \end{tikzpicture}%
      }%
