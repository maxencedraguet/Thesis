...
\paragraph{Cons:}
\begin{itemize}
    \item \textit{Limited Modelling of Sequential and Geometrical Data:} these networks are not naturally designed for handling sequential data and temporal dependencies nor images.
