\begin{table}[!htbp]
  ...
  \centering
    ...
    \begin{tabular}{c|ccc|ccc}
      ...
      \\\hline
      Boost type 
        & Gradient & Gradient & Gradient % VHbb Resolved 
    ...
    \end{tabular}}%
  \caption{%
    Hyperparameters of the BDTs per lepton channel of the \vhb\ resolved and boosted analyses. All models used the Gini index as separation method, without pruning.}%
