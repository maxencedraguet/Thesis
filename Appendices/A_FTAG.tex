...
The distributions of the samples used in the variable radius (\gls{vr}) jet training of \gls{dips} train are shown in Figure \ref{apfig:vrjetdist}. Figure \ref{fig:dipsVRROCgrav} presents the \gls{roc} curves on the graviton test sample.
